...
const RightSection = () => {
    ...
    return (
        ...
        >
            <h1 className="mb-6 text-4xl font-bold">Quên Mật Khẩu</h1>
            ...
            {success ? (
                <div className="w-4/6 space-y-4">
                    ...
                    <Link
                        ...
                        className="block w-full rounded-full bg-gradient-to-r from-[#1E4522] to-[#3A683D] px-6 py-3 text-center font-semibold text-white shadow-md transition hover:opacity-90"
                    >
                        Quay lại đăng nhập
                    </Link>
                </div>
                ...
                <>
                    <div className="mb-4 w-4/6 text-sm">
                        Nhập địa chỉ email đã đăng ký để nhận hướng dẫn khôi
                        phục mật khẩu.
                    </div>
